...
if uploaded_file:
    ...
    st.markdown(
        ...
        "<div style='font-size:89%;color:#339C73; margin-bottom:16px;'>AI-generated analysis from extracted Excel data with Schedule III compliance</div>",
        unsafe_allow_html=True
    )

    # 2. KPI Metric Cards (always on top row)
    ...
    # 3. Two-column main dashboard area (left: trends, right: pie + ratios)
        ...
        <div style='border: 1px solid #ecf3ec; border-radius:9px; background:#f8fefa;padding:18px 14px 7px 16px; font-size:1.13em;'>
            <table style='width:100%;border-collapse:collapse;'>
                ...
                <tr>
                    ...
                    <td style='font-weight:bold; text-align:right;'>{:.2f}</td>
                </tr>
            </table>
        </div>
    ...
    # Modern style override for metric cards
    st.markdown("""
    <style>
